...
* File: Reminder.java <servlet> (SWEN90002 Project 1)   *
********************************************************/
            ...
            if (previousRecord == null || previousRecord.compareTime() > FIVE_MINUTES) {
                ...
                if(userDB.find(email)) {
                    ...
                    //if((new SendEmail().sendEmail(subject, message, email))) {
                        ...
                        status = "success";
                        reminderQueue.add(r);
                        serverreply = "Please Check Your Email..";//<br>In Queue: "+reminderQueue.size();
                    }
                    else {
                        title = "Error Sending Reminder";
                        status = "emailfail";
                        serverreply = "Server Encounter Error Sending Email..<br>Please try again..<br><br><A HREF=\"javascript:history.go(0)\">Click to try again</A>";
                    }
                }
                else {  // return status of not yet a member.
                    status = "notAMEMBER";
                    title = "No Such User!";
                    serverreply = "No Record Found!<br><br>Please <a href=\"register.jsp\">Register An Account</a><br><br>Or recheck email address is correct!";
                }
            }
                ...
                serverreply = "Reminder Email had sent in less then "+sentTime+" minutes."
                        + "<br>Server restrict of 5 minutes cooldown period per email address."
                        + "<br>Please recheck your email."
                        + "<br><br>Or you may try to request again after "+cooldownTime+" minutes.<p>";
            }
        }
        else {
            serverreply = "Invalid Email!<br><br><A HREF=\"javascript:history.go(0)\">Try Again</A>";
        }
