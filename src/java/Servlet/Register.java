...
* File: Register.java <servlet> (SWEN90002 Project 1)   *
********************************************************/
            ...
            if(userDB.find(email)) {
                ...
                if (previousRecord == null || previousRecord.compareTime() > FIVE_MINUTES) {
                    ...
                    //if ((new SendEmail().sendEmail(subject, message, email))) {
                        ...
                        serverreply = email;//+" ("+registrationQueue.size()+")";
                        status = "sent";
                    }
                    else {
                    ...
                    serverreply = email+"<br><br><p>Confirmation Email had sent in less then "+sentTime+" minutes."
                            + "<br>Server restrict of 5 minutes cooldown period per email address."
                            + "<br>Please recheck your email to complete registration."
                            + "<br><br>Or you may try to register again after "+cooldownTime+" minutes.<p>";
                }
            }
